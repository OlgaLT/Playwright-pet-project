...
6.  Написать хотя бы три теста на одну страницу
6.  После этого попробовать запустить параллельно тесты
6.  Проанализировать ассерты в тестах, подумать что и как проверять
7.  [x] Добавить prettier и eslint
7.  Попробовать добавить правила для линтера asyns await и no-tests-only
8.  Попробовать написать тесты на api

## Задачи со звездочкой на будущее:

1. Добавить в проект по аналогии docker-compose с gitlabCI
